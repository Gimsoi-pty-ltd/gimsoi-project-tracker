...
export const PERMISSIONS = {
    [ROLES.ADMIN]: ['CREATE_TASK', 'UPDATE_TASK', 'UPDATE_ANY_TASK', 'DELETE_TASK', 'DELETE_OWN_TASK', 'VIEW_TASKS', 'VIEW_SPRINTS', 'MANAGE_PROJECTS', 'VIEW_CLIENTS', 'MANAGE_CLIENTS', 'VIEW_PROJECTS', 'MANAGE_SPRINTS', 'MANAGE_USERS', 'VIEW_USERS'],
