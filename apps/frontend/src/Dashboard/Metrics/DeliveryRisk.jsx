...
const DeliveryRisk = () => {
  ...
  return (
    <div
      className="w-full h-full min-h-[220px] bg-white border border-gray-200 rounded-2xl p-4 sm:p-5 lg:p-6 shadow-sm transition-all duration-300 hover:shadow-xl flex flex-col justify-between"
    >
