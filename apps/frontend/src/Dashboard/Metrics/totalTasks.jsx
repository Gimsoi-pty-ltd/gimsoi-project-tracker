...
const TotalTasks = () => {
  ...
  return (
    <div
      ...
      className="w-full min-h-[220px] bg-white border border-gray-200 rounded-2xl p-4 sm:p-5 lg:p-6 shadow-sm cursor-default transition-all duration-300 hover:shadow-xl flex flex-col justify-between"
    >
      ...
      <div className="mt-3">
        ...
        <div className="mt-4">
          <p className="text-sm text-gray-600">Tasks in current sprint</p>
        </div>
      </div>

      <div className="mt-6 flex items-center justify-between">
        <p className="text-[11px] sm:text-xs text-gray-400 max-w-[80%]">
          Total tasks in {sprintName}
        </p>
        <div
          className="flex items-center gap-1 text-sky-500 text-sm font-medium cursor-pointer"
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold text-gray-900">Total Tasks</h2>
              <button
          ...
          <div className="bg-orange-50 border border-orange-100 rounded-xl p-3 text-sm text-gray-700">
           Total Tasks = COUNT(tasks WHERE sprintId = current)
          </div>
        </div>
              ...
              <div>
                ...
                <div className="bg-gray-50 border rounded-xl p-3 text-sm text-gray-700 leading-relaxed">
                  The total number of tasks assigned to the current sprint, regardless of their status.
                </div>
              </div>
              <div>
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-3 text-sm text-gray-700">
                  {totalTasks} task(s) in {sprintName}.
                </div>
              </div>
            </div>
          </div>
