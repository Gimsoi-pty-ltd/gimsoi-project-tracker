      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 md:gap-6 mb-8 md:mb-12">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 w-full">
          ...
          <div className="flex-1 min-w-0">
            ...
            <span className="inline-block mt-1 text-xs bg-orange-500 text-white px-3 py-1 rounded-full font-medium">{user.role}</span>
          </div>
        </div>
        <NavyButton className="px-4 py-2 text-sm md:text-base font-semibold hover:bg-[#002d62] transition-colors" onClick={() => alert("Edit Profile functionality coming soon!")}>
          Edit Profile
        </NavyButton>
      </div>
