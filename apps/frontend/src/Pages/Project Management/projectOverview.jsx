    ...
    const Dashboard = () => (
        <div className="p-6 space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-5 rounded-xl shadow">
                ...
                <p className="text-sm text-gray-500 mt-1">Client: <span className="font-medium text-gray-700">{project.client}</span></p>
                <p className="text-sm text-gray-500 mt-1">Deadline: <span className="font-medium text-gray-700">{project.deadline}</span></p>
            </div>
            ...
            <NavyButton onClick={() => setScreen("edit")}>Edit Project</NavyButton>
        </div>
    );

    
    const EditScreen = () => {
        // Local draft so changes only apply on Save
        ...
        const addTeamMember = () => setDraft(prev => ({ ...prev, team: [...prev.team, ""] }));
        ...
        const handleSave = () => {
            setProject(draft); // ✅ commit draft to real project state
            setScreen("dashboard");
        };

        const inputClass = "w-full border border-gray-200 bg-gray-50 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition";
            ...
            <div className="p-6 max-w-4xl mx-auto space-y-6">
                ...
                <div className="mb-2">
                    ...
                    <nav className="flex mt-1 text-sm text-gray-500">
                        ...
                        <span className="mx-2">/</span>
                        <span className="hover:text-slate-600 cursor-pointer" onClick={() => setScreen("dashboard")}>
                            {project.name}
                        </span>
                        <span className="mx-2">/</span>
                        <span>Edit</span>
