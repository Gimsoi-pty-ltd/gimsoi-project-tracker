    ...
    <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 md:p-5">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <h2 className="text-base font-semibold text-[#001f44] truncate">Storage</h2>
        </div>
        <button
        ...
        <div className="bg-gray-50 border border-gray-200 p-4 rounded-md space-y-3">
          <div>
            ...
            <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
              <div className="bg-orange-500 h-2 rounded-full w-[65%] transition-all" />
            </div>
            <p className="text-xs text-gray-400 mt-1">65% used — 3.5GB remaining</p>
          </div>
        </div>
      )}
    </div>
