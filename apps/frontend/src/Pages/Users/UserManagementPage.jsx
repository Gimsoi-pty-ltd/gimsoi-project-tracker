...
const SectionCard = ({ section }) => {
  ...
  return (
    <div
      ...
      className="bg-white border border-gray-200 rounded-2xl p-5 md:p-6 shadow-sm hover:shadow-md transition-all cursor-pointer group"
    >
      <div className="flex items-start justify-between mb-4">
        <div className={`p-2.5 md:p-3 rounded-xl border ${colorClasses[section.color]}`}>
          <Icon size={22} />
        </div>
        <ArrowRight
          size={18}
      ...
      <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-2">{section.label}</h3>
      <p className="text-gray-600 text-sm mb-5 md:mb-6">{section.description}</p>
    ...
    <div className="bg-gray-50 min-h-screen p-4 md:p-8">
      <div className="mx-auto">
        ...
        <div className="flex flex-wrap gap-2 md:gap-3 mb-6 md:mb-8">
          <button className="px-3 md:px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2">
            + Add New
          </button>
          <button className="px-3 md:px-4 py-2 border text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors bg-white">
            Import Data
          </button>
          <button className="px-3 md:px-4 py-2 border text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors bg-white">
            Export Report
        ...
        {/* Recent Activity */}
        <div className="mt-8 md:mt-12 bg-white border rounded-2xl p-4 md:p-6">
