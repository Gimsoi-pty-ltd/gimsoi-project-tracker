...
import { Calendar, DollarSign, AlertCircle, Users, Check, Code, Loader2, Filter } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="md:flex md:items-center md:justify-between mb-8">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Project Report</h2>
        ...
        <button className="mt-4 md:mt-0 inline-flex items-center px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 text-sm font-medium shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <ProjectStatCard title="Budget Used" value="65%" icon={<DollarSign />} color="green" />
        <ProjectStatCard title="Risks" value="2 Low" icon={<AlertCircle />} color="purple" />
          ...
          <div className="flow-root">
            <ul role="list" className="-mb-8">
              <TimelineItem 
                ...
                subtitle="Completed by Kelebogile" 
                time="2 days ago" 
              />
              <TimelineItem 
...
const ProjectStatCard = ({ title, value, icon, color }) => (
  <div className={`bg-white overflow-hidden shadow-sm rounded-lg p-5 border-l-4 border-${color}-500`}>
